...
// Id doesn't exist
func GetHeroById(id int64) (v *Hero, err error) {
	o := orm.NewOrm()
	v = &Hero{Id: id}
	if err = o.QueryTable(new(Hero)).Filter("Id", id).RelatedSel().One(v); err == nil {
		return v, nil
	}
	return nil, err
}
...
func DeleteHero(id int64) (err error) {
	o := orm.NewOrm()
	v := Hero{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
